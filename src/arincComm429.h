...
public:
    ...
    Q_INVOKABLE void setSendBytesArinc429(const int fd,long sendBytesArinc429);
    void appendRecvArinc429(const int fd,const QString &recvArinc429);
    //void setHexArinc42901(const int fd,bool hexArinc42901);
    Q_INVOKABLE void saveFileClick(int fd,bool saveFile);

     Q_INVOKABLE void setHexArinc429(int fd,bool hexARINC429);
...
private:
    ...
    bool m_HexArinc429[arinc429PortNum]={true};
